#!/bin/bash
# Converted from make_bagman_proms.bat
...
cat e9_b05.bin f9_b06.bin f9_b07.bin k9_b08.bin m9_b09s.bin n9_b10.bin > prog.bin
cat p3.bin r3.bin > bagman_palette.bin
cat e1_b02.bin c1_b01.bin  > bagman_tile0.bin
cat j1_b04.bin f1_b03s.bin > bagman_tile1.bin
...
rm prog.bin bagman_palette.bin bagman_tile0.bin bagman_tile1.bin
